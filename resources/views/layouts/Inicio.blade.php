...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="description" content="proyecto para tesis" />
        <meta name="author" content="jose manuel sanchez juarez" />
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="{{route('home')}}">Fracciones</a>
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <div class="sb-sidenav-menu-heading">Alumnos</div>
                            <!-- menu de alumnos -->
                                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseAlumnos" aria-expanded="false" aria-controls="collapseAlumnos">
                            ...
                            <!-- fin de menu alumnos -->
                            <div class="sb-sidenav-menu-heading">Temas</div>
                            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTemas" aria-expanded="false" aria-controls="collapseTemas">

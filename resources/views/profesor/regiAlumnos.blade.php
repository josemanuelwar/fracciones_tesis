        ...
        <div class="card-body">
            <form method="POST" action="{{route('Agregar')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" aria-describedby="nombreHelp" placeholder="Ingresa el nombre" value="{{old('nombre')}}">
                       {!! $errors->first('nombre','<br><small id="nombreHelp" class="alert alert-danger">:message</small>') !!}
                </div>
                <div class="form-group">
                    <label for="app">Apellido Paterno</label>
                    <input type="text" class="form-control" id="app" name="app" aria-describedby="appHelp" placeholder="Ingresa el apellido paterno" value="{{old('app')}}">
                    {!! $errors->first('app','<br><small id="appHelp" class="alert alert-danger">:message</small>')!!}
                </div>
                <div class="form-group">
                    <label for="apm">Apellido Materno</label>
                    <input type="text" class="form-control" id="apm" name="apm" aria-describedby="apmHelp" placeholder="Ingresa el apellido materno" value="{{old('apm')}}">

...
Route::get('/profesor', [App\Http\Controllers\HomeController::class, 'index'])->name('home');
...
Route::post('/guardarTemas',[App\Http\Controllers\HomeController::class, 'guardarTemas'])->name('guardarTemas');
Route::get('/listatemasgrado/{id}',[App\Http\Controllers\HomeController::class, 'ListaTemas']);
/**editamos un tema */
Route::post('/EditarTema',[App\Http\Controllers\HomeController::class,'EditarTema'])->name('temaeditar');
...
Route::post('/eliminar',[App\Http\Controllers\ProfesorController::class, 'EliminarEscuela'])->name('eliminarEs');
...
Route::post('/eliminarmateria',[App\Http\Controllers\ProfesorController::class,'eliminarMaterias'])->name('Materiaselimnar');
